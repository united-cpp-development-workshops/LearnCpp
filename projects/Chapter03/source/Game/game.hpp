...
namespace Game
{
  ...
  inline constexpr fn::u8f  COURT_CARD_VALUE{10};
  inline constexpr fn::u8f  ACE_HIGH_VALUE{11};
  inline constexpr fn::u8f  ACE_LOW_VALUE{1};
  inline constexpr fn::size DECK_COUNT{6};
  inline constexpr fn::f64  SHUFFLE_THRESHOLD{0.5};
  inline constexpr fn::u8f  BLACKJACK{21};
  inline constexpr fn::u8f  DEALER_STAND{17};
  inline constexpr fn::u8f  MIN_BET{10};
  inline constexpr fn::u8f  WIN_MULTIPLIER{2};
